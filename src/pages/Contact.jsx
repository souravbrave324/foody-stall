...
const Contact = () => {
  const contactInfo = [
    { icon: <Phone size={20} />, title: "Call Us", detail: "+91 98765 43210", sub: "Mon-Fri, 9am-10pm" },
    { icon: <Mail size={20} />, title: "Email Us", detail: "hello@cafenova.com", sub: "Response within 24hrs" },
